...
Future<String> digestFilePathAndPrepareDirectory({required String parentDirectory, required String fileName}) async {
  ...
  // Security (backport of 1.17.0 fix): a malicious sender can put "../" in the
  // file name to escape the destination directory (path traversal). Reject it.
  if (fileNameParts.length > 1 && !p.isWithin(parentDirectory, dir)) {
