...
const _customColorKey = 'ls_custom_color'; // user-picked theme seed color (ARGB int)
...
class PersistenceService {
  ...
  /// Custom theme seed color as an ARGB int. `null` = use the default (teal).
  int? getCustomColor() {
    return _prefs.getInt(_customColorKey);
  }
  ...
  Future<void> setCustomColor(int? color) async {
    if (color == null) {
      ...
      await _prefs.setInt(_customColorKey, color);
    }
  }
